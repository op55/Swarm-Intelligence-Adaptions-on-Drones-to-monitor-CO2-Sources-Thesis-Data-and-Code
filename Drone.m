classdef Drone
    ...
    properties        
        ...
        % Variables used for M-PSO, M-FA, M-ABC and ZZC:
        VELOCITIES;     % Used to determine a drone's movement speed.

        % Variables used for M-PSO and M-FA:
        M_ROLE;    % Used to determine what action a drone does.        

        % Variables used for M-ABC and ZZC's Scanning Functionality:
        STAY_COUNTER;               % The iteration a drones stays in a spot.
        THRESHOLD_FOUND;            % Tells a drone has found severe pollution.
        
        % Variables used for M-ABC:
